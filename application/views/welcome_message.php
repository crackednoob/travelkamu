      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="assets/pages/forms/travelkamu.php"><i class="fa fa-circle-o"></i> TravelKamu</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <!-- See dist/js/assets/pages/dashboard.js to activate the todoList plugin -->
              <ul class="todo-list">
                <li>
                  <!-- drag handle -->
                  <span class="handle">
...
<!-- jvectormap -->
<script src="assets/splugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
